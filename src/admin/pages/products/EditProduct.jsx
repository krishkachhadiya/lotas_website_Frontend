...
export default function EditProductPage() {
  ...
  async function handleUpdate(e) {
    ...
    if (productExists || slugExists) {
      alert("Please resolve duplicate Title or Slug validation issues before saving.");
      return;
    }
        ...
        <form onSubmit={handleUpdate} className="space-y-6 md:space-y-8">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full border border-gray-300 bg-white text-black p-3.5 md:p-4 rounded-xl outline-none focus:ring-2 focus:ring-black resize-none h-28 text-sm md:text-base"
            />
          </div>
