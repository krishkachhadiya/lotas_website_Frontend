...
export default function EditCategoryPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4 sm:p-6 md:p-8 w-full">
      <div className="max-w-6xl mx-auto bg-white rounded-2xl md:rounded-3xl shadow-xl p-5 sm:p-8 md:p-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-6 md:space-y-8">
          ...
          <div>
            ...
            <input
              ...
              className="w-full border border-gray-300 bg-white text-black p-3 md:p-4 rounded-xl outline-none focus:ring-2 focus:ring-black transition text-sm md:text-base"
            />
            {titleExists && (
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full border border-gray-300 bg-white text-black p-3 md:p-4 rounded-xl outline-none focus:ring-2 focus:ring-black transition text-sm md:text-base resize-none"
            />
          </div>
            ...
            <div className="text-black pt-4">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-5">
                ...
                <button
                  ...
                  className="w-full sm:w-auto bg-black text-white text-center px-5 py-2.5 rounded-xl text-sm md:text-base font-medium transition hover:bg-gray-800 shadow-sm"
                >
                  Add Subcategory
                </button>
              </div>
              ...
              <div className="overflow-x-auto border border-gray-200 rounded-2xl bg-white w-full scrollbar-thin">
          ...
          <div className="pt-4">
            <button
              ...
              className="w-full sm:w-auto bg-black hover:bg-gray-800 text-white px-8 md:px-10 py-3 md:py-4 rounded-xl text-base md:text-lg font-semibold transition disabled:opacity-50 disabled:cursor-not-allowed shadow-md"
            >
              Update Category
            </button>
          </div>
