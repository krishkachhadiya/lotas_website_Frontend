...
const navigate = useNavigate();
  ...
  return (
    ...
    <div className="min-h-screen bg-gray-100 p-4 sm:p-6 md:p-10 w-full">
      {/* Content panel auto-scales grid and paddings down for mobile */}
      <div className="max-w-5xl mx-auto bg-white rounded-2xl md:rounded-3xl shadow-xl p-5 sm:p-8 md:p-10">
        
        {/* Header */}
        <div className="mb-6 md:mb-10">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-black break-words">
            Add CMS Page
          </h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6 md:space-y-8">
          ...
          <div>
            ...
            <input
              ...
              className="w-full border border-gray-300 bg-white text-black p-3 md:p-4 rounded-xl outline-none focus:ring-2 focus:ring-black text-sm md:text-base"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full border border-gray-300 bg-white text-black p-3 md:p-4 rounded-xl outline-none focus:ring-2 focus:ring-black text-sm md:text-base resize-none"
            />
          </div>

          {/* Content Editor Layout Control */}
          <div className="text-black max-w-full overflow-hidden">
            <label className="block text-base md:text-lg font-semibold text-gray-700 mb-2 md:mb-3">
              Content
            </label>
          ...
          <div className="pt-2">
            <button
              ...
              className="w-full sm:w-auto bg-black hover:bg-gray-800 text-white px-8 md:px-10 py-3 md:py-4 rounded-xl text-base md:text-lg font-semibold transition disabled:opacity-50 disabled:cursor-not-allowed text-center"
            >
              Create Page
            </button>
          </div>
