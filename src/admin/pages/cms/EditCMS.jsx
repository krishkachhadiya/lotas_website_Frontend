    ...
    return (
        <div className="min-h-screen bg-gray-100 p-10">
            <div className="max-w-5xl mx-auto bg-white rounded-3xl shadow-xl p-10">
                ...
                {/* Header Titles */}
                <div className="mb-10">
                    <h1 className="text-5xl font-bold text-black">Edit CMS Page</h1>
                    <p className="text-gray-500 mt-3 text-lg">Update website page properties</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div>
                        ...
                        />
                        {pageExists && (
                            <p className="text-red-500 text-sm mt-2">Another page already uses this title.</p>
                        )}
                    </div>
                    ...
                    <div>
                        ...
                        />
                        {slugExists && (
                            <p className="text-red-500 text-sm mt-2">This clean link path is already occupied.</p>
                        )}
                    </div>
